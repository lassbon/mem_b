define({ "api": [
  ...
  {
    "type": "get",
    "url": "/api/v1/events/completed/:id",
    "title": "Get event(s)",
    "name": "GetCompleted",
    "description": "<p>This is where completed events are retrieved.</p>",
    "group": "Event",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/events/ongoing/:id",
    "title": "Get event(s)",
    "name": "GetOngoing",
    "description": "<p>This is where ongoing events are retrieved.</p>",
    "group": "Event",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "put",
    "url": "/api/v1/forum/censor/:id/:action",
    "title": "Censor a forum post",
    "name": "CensorPost",
    "description": "<p>This is where a forum post is censored.</p>",
    "group": "Forum",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "action",
            "description": "<p>To censor forum post or not (expects a boolean).</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "CensorActionNotProvided",
            "description": "<p>No action provided.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
  ...
  {
    "type": "get",
    "url": "/api/v1/forum/censore",
    "title": "Get censored post(s)",
    "name": "GetCensoredPost_s_",
    "description": "<p>This is where censored forum post(s) is retrieved</p>",
    "group": "Forum",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "post",
    "url": "/api/v1/forum/post/like",
    "title": "Like a post",
    "name": "LikePost",
    "description": "<p>This is where a forum post is liked</p>",
    "group": "Forum",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "post",
    "url": "/api/v1/forum/post/unlike",
    "title": "Unlike a post",
    "name": "UnlikePost",
    "description": "<p>This is where a forum post is unliked</p>",
    "group": "Forum",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/userpayments/dues/:id",
    "title": "Get user due payments",
    "name": "Dues",
    "description": "<p>This is where user due payment records are obtained.</p>",
    "group": "Payments",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "version": "0.0.0",
    "filename": "api/controllers/UserPaymentsController.js",
    "groupTitle": "Payments",
    "error": {
      "fields": {
        "Error 4xx": [
  ...
  {
    "type": "get",
    "url": "/api/v1/payments/due/excel",
    "title": "Get dues payment Excel document",
    "name": "GetDueExcel",
    "description": "<p>This is where membership dues payment records are obtained in excel format.</p>",
    "group": "Payments",
    "version": "0.0.0",
    "filename": "api/controllers/PaymentsController.js",
    "groupTitle": "Payments"
  ...
  },
  {
    ...
    "name": "Memberships",
    "description": "<p>This is where user membership payment records are obtained.</p>",
    "group": "Payments",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/projects/completed/:id",
    "title": "Get project(s)",
    "name": "GetCompleted",
    "description": "<p>This is where completed projects are retrieved.</p>",
    "group": "Project",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/projects/ongoing/:id",
    "title": "Get project(s)",
    "name": "GetOngoing",
    "description": "<p>This is where ongoing projects are retrieved.</p>",
    "group": "Project",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "name": "GetUserFriends",
    "description": "<p>This is where users friends is retrieved.</p>",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/userpayments/donations/:id",
    "title": "Get user donation payments",
    "name": "Donations",
    "description": "<p>This is where user donation payment records are obtained.</p>",
    "group": "UserPayments",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/v1/userpayments/events/:id",
    "title": "Get user event payments",
    "name": "Events",
    "description": "<p>This is where user event payment records are obtained.</p>",
    "group": "UserPayments",
    "parameter": {
      "fields": {
        "Parameter": [
