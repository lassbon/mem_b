...
module.exports.routes = {
  ...
  ***************************************************************************/
   ...
   */
  'POST /api/v1/knowledgebase' : 'KnowledgeBaseController.create',
  'PUT /api/v1/knowledgebase/:id' : 'KnowledgeBaseController.update',
  'DELETE /api/v1/knowledgebase/:id' : 'KnowledgeBaseController.delete',
  'GET /api/v1/knowledgebase/:id' : 'KnowledgeBaseController.get',
  'GET /api/v1/knowledgebase' : 'KnowledgeBaseController.get',
